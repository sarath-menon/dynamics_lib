#include "quadcopter_frame_plus.h"
#include <iostream>

// Setter functions

QuadcopterFramePlus ::QuadcopterFramePlus() {}

/// Equations of motion for a quadcopter frames
void QuadcopterFramePlus::dynamics(const matrix::Vector3f body_thrust,
...
void QuadcopterFramePlus::euler_step(const float dt) {
