#include "quadcopter_frame_x.h"
#include <iostream>

// Setter functions

QuadcopterFrameX ::QuadcopterFrameX() {}

/// Equations of motion for a quadcopter frames
void QuadcopterFrameX::dynamics(const matrix::Vector3f body_thrust,
...
void QuadcopterFrameX::euler_step(const float dt) {
